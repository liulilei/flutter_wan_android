...
Map<String, dynamic> $ArticleInfoToJson(ArticleInfo entity) {
...
ArticleInfoDatas $ArticleInfoDatasFromJson(Map<String, dynamic> json) {
	...
	if (realSuperChapterId != null) {
		articleInfoDatas.realSuperChapterId = realSuperChapterId;
	}
